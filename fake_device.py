...
class Device(object):
    ...
    device_type = "E-Meter"
    server_url = "http://data.okosengineering.com"
    data_path = "/api/data/"
    ...
    def send_data(self):
        ...
        resp = requests.post(self.server_url + self.data_path, data=data, headers={
            'Device': self.token
        })
        self.data = {}
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(e)
        dev = Device(device_type="Solar", token='673b27eed5e1ccc598265d25f4e525e5dce1d837')

    dev.send_data()
    
    pickle.dump(dev, open( "dev.p", "wb" ) )
